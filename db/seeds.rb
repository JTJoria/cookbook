User.create!([
  {email: "me@me.com", encrypted_password: "$2a$10$CjlL.xoyvrLTBRdxnkQq2uMK/I9wN3vTVOEwGmjpXvEg2u9qI.u/m", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2016-01-27 02:34:47", last_sign_in_at: "2016-01-27 02:34:47", current_sign_in_ip: "::1", last_sign_in_ip: "::1"}
])
Recipe.create!([
  ...
  {title: "Cold Pizza", chef: "You", ingredients: "Pizza", directions: "Refrigerate pizza, eat tomorrow", image: nil, prep_time: nil}
])
